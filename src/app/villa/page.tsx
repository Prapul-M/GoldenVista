            ...
            >
              ...
              <div className="flex justify-between mb-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-medium">{villaDetails.bedrooms}</p>
                </div>
                <div className="text-center">
                  <FaBath className="text-primary text-3xl mx-auto mb-2" />
                  <p className="text-gray-500">Bathrooms</p>
                  <p className="text-xl font-medium">{villaDetails.bathrooms}</p>
                </div>
                <div className="text-center">
                  <FaBuilding className="text-primary text-3xl mx-auto mb-2" />
                  <p className="text-gray-500">Balconies</p>
                  <p className="text-xl font-medium">{villaDetails.balconies}</p>
                </div>
              </div>
              ...
              <div className="border-t border-b border-gray-200 py-6 mb-6">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-2xl text-primary font-bold">{villaDetails.price}</span>
                </div>
              </div>
