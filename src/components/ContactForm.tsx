...
const ContactForm = () => {
  ...
  return (
    <div className="bg-white p-8 shadow-xl">
      <h3 className="font-serif text-3xl mb-6">Get in Touch</h3>
      
      {isSuccess ? (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="bg-green-50 text-green-800 p-4 mb-6 rounded"
        >
        ...
        <form onSubmit={handleSubmit}>
          {error && (
            <div className="bg-red-50 text-red-800 p-4 mb-6 rounded">{error}</div>
          )}
